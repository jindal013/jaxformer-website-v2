...
0 & 0& \ldots & \ldots & & \cos(m\theta_{d/2}) & -\sin(m\theta_{d/2}) \\
0 & 0 & \ldots & \ldots & & \sin(m\theta_{d/2}) &  \cos(m\theta_{d/2})
\end{bmatrix}
}_{\displaystyle R(m) \;=\; \mathrm{blockdiag}\big(R(m\theta_1),\ldots,R(m\theta_{d/2})\big)}
\begin{bmatrix}
x_1 \\ 
x_2 \\ 
\vdots \\ 
